...
export function GitLabMergeRequestPicker({
  ...
  return (
    <div className="gitlab-picker">
      <label className="gitlab-picker-label" htmlFor="gitlab-mr-select">
      ...
      <div className="gitlab-picker-control">
        {mergeRequests.length > 0 || selectedMr ? (
          <span className="gitlab-select">
            ...
            >
              ...
              {mergeRequests.map((mr) => (
                <option key={optionValue(mr)} value={optionValue(mr)}>
          ...
          <span className="gitlab-picker-empty">
            {loading
        ...
        <button
          type="button"
          className="gitlab-picker-action"
          onClick={onReload}
          disabled={loading}
